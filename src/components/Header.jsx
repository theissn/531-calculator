  ...
  return (
    <>
      <header class="sticky top-0 z-10 bg-bg border-b border-border">
        <div class="flex items-center justify-between px-4 h-12 max-w-lg mx-auto w-full">
          <h1 class="text-lg font-bold tracking-tighter text-text font-mono upper">
            SYSTEM: 5/3/1
          </h1>
          <div class="flex items-center gap-3">
            <button
              class="w-9 h-9 flex items-center justify-center border border-border hover:bg-bg-hover text-text-muted hover:text-text transition-colors rounded-none"
              aria-label="Calendar"
            ...
            <button
              class="w-9 h-9 flex items-center justify-center border border-border hover:bg-bg-hover text-text-muted hover:text-text transition-colors rounded-none -mr-1"
              aria-label="Settings"
